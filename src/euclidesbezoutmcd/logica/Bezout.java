...
public class Bezout {
    private List<Division> listaDivisiones;
    private int [] numerosIniciales;
    private int mcd;
    private List<String> listaRegresion;
    private List<int []> listaIdentidades;
    private String combinacionLineal;
        

    public Bezout(List<Division> divisiones, int [] numeros, int mcd){
        this.listaDivisiones = divisiones;
        this.numerosIniciales = numeros;
        this.mcd = mcd;
        this.listaRegresion = new ArrayList<>();
        this.listaIdentidades = new ArrayList<>();
    }
    
    public void realizarCombinacionLineal(){
        int [] aux;
        String linea;
        
        // Diccionario para manejar los números iniciales y sus coeficientes
        Map <Integer, Integer> listaCoeficientes = new HashMap<>();
    ...
    public List<String> getListaIdentidades(){
...
//                retorno.add(linea[0] + " = " + linea[1] + " - " + linea[2]);
    ...
    public String getCombinacionLineal() {
